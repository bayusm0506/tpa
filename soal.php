...
$(document).ready(function(){
    ...
    url = "ambilsoal.php?publish="+publish
    $.ajax({
        url: url,
        dataType: 'json',
        cache: false,
...
function tampilkan(){
    if(indexsoal<publish.soal.length){
        ...
        $("#jawaban_a").html("<input type='radio' onclick='setnilai(this.value)' name='R"+indexsoal+"'value='A'> "+publish.soal[indexsoal].A);
        $("#jawaban_b").html("<input type='radio' onclick='setnilai(this.value)' name='R"+indexsoal+"'value='B'> "+publish.soal[indexsoal].B);
...
.waktu{padding:10}
#divpertanyaan{padding:10;background-color:rgb(164, 255, 0);  font-size: 15px;display:none;}
    ...
    <div class="main">
        <div class="soal">
            ...
            ?>
                      ...
                      <p>Petunjuk Pengisian :<br>
                            Silahkan anda menjawab pertanyaan-pertanyaan dibawah ini dengan sejujur-jujurnya, dengan ketentuan memilih tanda :<br>(+) Sesuai dengan diri anda <br> (-)  Tidak sesuai dengan diri anda <br></p>
            <h4>Selamat Mengerjakan</h4></p>
