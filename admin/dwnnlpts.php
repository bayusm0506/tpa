<?php
	$nama_file = date('d-n-Y')."_laporan_hasil_tes_potensi_akademik_mahasiswa.xls";
...
$kunci = $_POST['thn_ini'];
$q = mysql_query("select * from nilai_pts inner join tbl_formulir_tpa on nilai_pts.id_user = tbl_formulir_tpa.no_formulir where left(tbl_formulir_tpa.thn_ajaran,4) = '$kunci' order by tbl_formulir_tpa.fakultas ASC, tbl_formulir_tpa.prodi ASC, nilai_pts.tanggal ASC");
$n = 1;
