<?php
	$nama_file = date('d-n-Y')."_laporan_hasil_tes_personaliti_akademik_mahasiswa_per_fakultas.xls";
...
$q = mysql_query("select * from nilai inner join tbl_formulir_tpa on nilai.id_user = tbl_formulir_tpa.no_formulir where left(tbl_formulir_tpa.thn_ajaran,4) = '$kunci' AND tbl_formulir_tpa.fakultas LIKE'%$fakultas%' order by tbl_formulir_tpa.fakultas ASC, tbl_formulir_tpa.prodi ASC, nilai.tanggal ASC");
$n = 1;
