...
?>
<div class="span12">
	<span class="text-info"><h4>Daftar Nilai Tes Potensi Akademik</h4><hr /></span>
	...
	$no=1; 
	$query=mysql_query("select * from nilai_pts inner join tbl_formulir_tpa on nilai_pts.id_user = tbl_formulir_tpa.no_formulir where tbl_formulir_tpa.thn_ajaran = '$thn_akad' order by tbl_formulir_tpa.no_formulir desc");
	...
	koneksi_tutup();
	echo '<p>Download semua dalam format <a href="exnlpts.php" target="_new">Excel</a></p>';
	?>
	</tbody>
    </table>
</div>
