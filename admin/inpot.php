...
if (isset($_POST['submit']))
    {
        ...
        $query=mysql_query("INSERT INTO nilai_pts VALUES(NULL, '$no_formulir', '$nilai', NOW())");
              koneksi_tutup();
              if($query){
                  echo "<B><font color=red>Nilai Tes Potensi Akademik berhasil disimpan.</font> </B>";
                exit();
              }else{
                  echo mysql_error();
                  exit();
...
<body onLoad="document.daftar.elements['no_formulir'].focus()">
	<div class="span12">
      <span class="text-info"><h4>Input Skor Nilai Potensi Akademik</h4><hr></span>
    	<form enctype="multipart/form-data" action="?page=inpot" method="post" name="daftar" class="form-horizontal">
