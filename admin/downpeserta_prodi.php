<?php
	$nama_file = date('d-n-Y')."_laporan_peserta_tpa_per_prodi.xls";
...
$kunci = $_POST['thn_ini'];
$prodi = $_POST['prodi'];
$q = mysql_query("select * from tbl_formulir_tpa where left(thn_ajaran,4)='$kunci' AND prodi LIKE'%$prodi%' order by tbl_formulir_tpa.fakultas ASC, tbl_formulir_tpa.prodi ASC, tbl_formulir_tpa.tgl_surat ASC");
$n = 1;
